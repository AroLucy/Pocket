...
curl -fsSL https://raw.githubusercontent.com/LucyUwI/Pocket/main/Pocket/user.css -o ~/.config/spicetify/Themes/Pocket/user.css
curl -fsSL https://raw.githubusercontent.com/LucyUwI/Pocket/main/Pocket/color.ini -o ~/.config/spicetify/Themes/Pocket/color.ini
